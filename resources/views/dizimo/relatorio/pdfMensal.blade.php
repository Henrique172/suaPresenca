...
<div id="pdf"  style="margin: 0 auto">
    ...
    @endphp
        ...
        <div class="fundo">
            ...
            <h1 style="text-align:center"> {{ isset($consulta[0]) ?  'Relatório Dizimos/Ofertas de '.strftime('%B de %Y', strtotime($data->format('m/d/Y'))) : 'Nao a dizimo cadastrado nesse mes' }}</h1>
            <br />
            @php $valor = 0; @endphp
